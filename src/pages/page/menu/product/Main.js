...
export default class Main extends React.Component {
  onChange(index) {
    actions.page.product_info.selectMenu(index);
  }

  onAdd() {
    actions.page.product_info.addContent({});
  }

  onUpItem(index) {
    actions.page.product_info.upContent(index);
  }

  onRemoveItem(index) {
    actions.page.product_info.removeContent(index);
  }
